    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdministrar" class="collapse" aria-labelledby="headingAdministrar"
            ...
            <!-- Nav Item - Guardados Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGuardados"
                    aria-expanded="true" aria-controls="collapseGuardados">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Dar Permisos y Modifica Usuarios</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <img src="img/reload.png" id="reloadbtn" style="cursor:pointer;height:36px;width:fit-content">
                                        ...
                                        $resultusuarios = $conexion->query($sqlusuarios);          
                                         if ($resultusuarios->num_rows > 0) {
                                            while ($row = $resultusuarios->fetch_assoc()) {
                                                ...
                                                echo '<tr><td>' . $row['global_id'] .
                                                 '</td><td>'  . $row['nombre'] . ' ' . $row['ap_paterno'] .
                                                 '</td><td>' . $tu .
                                                 '</td><td align="center"><form action="darPriv.php" method="post"><input onclick="cmP()" class="switch" type="checkbox" name="dP" id="switchPrivilegios"' . $ch  .'>'.
                                                    '<input type="text" name="usr" value="' . $row['global_id'] .'" style="display:none" id="ide"><input style="display:none" type="submit" id="btn_eP'.$row['global_id'].'"></form>' .
                                                 
                                                    '</td><td align="center"><form action="API/API/eliminarU.php" method="post"><input type="text" value="'.$row['global_id'].'" name="idel" style="display:none"><button type="submit" class="btn btn-danger btn-circle btn-sm"><img src="img/del.png" width="170%" height="fit-content"></button></form></td></tr>';
